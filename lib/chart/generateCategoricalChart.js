...
var generateCategoricalChart = function generateCategoricalChart(_ref6) {
  ...
  var getFormatItems = function getFormatItems(props, currentState) {
    ...
    graphicalItems.forEach(function (item, index) {
      ...
      var axisObj = axisComponents.reduce(function (result, entry) {
         ...
         */
        !(axisMap && axisMap[id] || entry.axisType === 'zAxis') ? process.env.NODE_ENV !== "production" ? (0, _tinyInvariant["default"])(false, "Specifying a(n) ".concat(entry.axisType, "Id requires a corresponding ").concat(entry.axisType, "Id on the targeted graphical component ").concat((_item$type$displayNam = item === null || item === void 0 || (_item$type = item.type) === null || _item$type === void 0 ? void 0 : _item$type.displayName) !== null && _item$type$displayNam !== void 0 ? _item$type$displayNam : '')) : (0, _tinyInvariant["default"])(false) : void 0;
  ...
  return _class = /*#__PURE__*/function (_Component) {
    ...
    function CategoricalChartWrapper(_props) {
      ...
      _defineProperty(_assertThisInitialized(_this), "renderActiveBar", function (_ref13) {
        var item = _ref13.item,
          childIndex = _ref13.childIndex;
        var key = item.props.key;
         ...
         */
        var inheritedProps = _objectSpread(_objectSpread({}, item.item.props), item.props.data[childIndex]);
        var barProps = _objectSpread(_objectSpread(_objectSpread({
          index: childIndex,
          dataKey: dataKey,
          fill: (0, _ChartUtils.getMainColorOfGraphicItem)(item.item),
          strokeWidth: 2,
          stroke: '#fff',
          key: "".concat(key, "-activeBar-").concat(childIndex)
        }, inheritedProps), (0, _ReactUtils.filterProps)(activeBar)), (0, _types.adaptEventHandlers)(activeBar));
        return /*#__PURE__*/_react["default"].createElement(_BarUtils.ActiveBar, _extends({
          option: activeBar
        }, barProps));
      });
      _defineProperty(_assertThisInitialized(_this), "renderGraphicChild", function (element, displayName, index) {
        ...
        var _item$item$props3 = item.item.props,
          activeDot = _item$item$props3.activeDot,
          hide = _item$item$props3.hide,
          activeBar = _item$item$props3.activeBar;
        ...
        if (hasActive) {
          ...
          if (activeBar) {
            return [graphicalItem, _this.renderActiveBar({
              item: item,
