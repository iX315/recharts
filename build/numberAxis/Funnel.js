...
var Funnel = (function (_super) {
    ...
    Funnel.prototype.renderTrapezoidsStatically = function (trapezoids) {
        ...
        return trapezoids.map(function (entry, i) {
            ...
            return (react_1.default.createElement(Layer_1.Layer, __assign({ className: "recharts-funnel-trapezoid" }, types_1.adaptEventsOfChild(_this.props, entry, i), { key: "trapezoid-" + i, role: "img" }), Funnel.renderTrapezoidItem(trapezoidOptions, trapezoidProps)));
        });
    };
