...
var toArray = function (children) {
    ...
    react_1.Children.forEach(children, function (child) {
        ...
        if (react_is_1.isFragment(child)) {
            result = result.concat(exports.toArray(child.props.children));
        }
        else {
            result.push(child);
        }
...
function findAllByType(children, type) {
    ...
    exports.toArray(children).forEach(function (child) {
...
var isDotProps = function (dot) {
    return dot && typeof dot === 'object' && 'cx' in dot && 'cy' in dot && 'r' in dot;
};
exports.isDotProps = isDotProps;
var isValidSpreadableProp = function (property, key, includeEvents, svgElementType) {
    var _a;
    var matchingElementTypeKeys = (_a = types_1.FilteredElementKeyMap === null || types_1.FilteredElementKeyMap === void 0 ? void 0 : types_1.FilteredElementKeyMap[svgElementType]) !== null && _a !== void 0 ? _a : [];
    return ((!lodash_1.default.isFunction(property) &&
...
var filterSvgElements = function (children) {
    var svgElements = [];
    exports.toArray(children).forEach(function (entry) {
...
var filterProps = function (props, includeEvents, svgElementType) {
    ...
    Object.keys(inputProps).forEach(function (key) {
        if (exports.isValidSpreadableProp(inputProps === null || inputProps === void 0 ? void 0 : inputProps[key], key, includeEvents, svgElementType)) {
...
var renderByOrder = function (children, renderMap) {
    var elements = [];
    var record = {};
    exports.toArray(children).forEach(function (child, index) {
...
var parseChildIndex = function (child, children) {
    return exports.toArray(children).indexOf(child);
};
