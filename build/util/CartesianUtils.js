...
var formatAxisMap = function (props, axisMap, offset, axisType, chartName) {
    ...
    var hasBar = !!ReactUtils_1.findChildByType(children, Bar_1.Bar);
    return ids.reduce(function (result, id) {
        ...
        if (axis.type === 'number' && (axis.padding === 'gap' || axis.padding === 'no-gap')) {
            ...
            if (axis.padding === 'no-gap') {
                var gap = DataUtils_1.getPercentValue(props.barCategoryGap, smallestDistanceInPercent * rangeWidth);
...
var getAngledRectangleWidth = function (_a, angle) {
    var width = _a.width, height = _a.height;
    if (angle === void 0) { angle = 0; }
    var normalizedAngle = normalizeAngle(angle);
    var angleRadians = (normalizedAngle * Math.PI) / 180;
    var angleThreshold = Math.atan(height / width);
    var angledWidth = angleRadians > angleThreshold && angleRadians < Math.PI - angleThreshold
