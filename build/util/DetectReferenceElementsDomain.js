...
var detectReferenceElementsDomain = function (children, domain, axisId, axisType, specifiedTicks) {
    var lines = ReactUtils_1.findAllByType(children, ReferenceLine_1.ReferenceLine);
    var dots = ReactUtils_1.findAllByType(children, ReferenceDot_1.ReferenceDot);
    var elements = __spreadArrays(lines, dots);
    var areas = ReactUtils_1.findAllByType(children, ReferenceArea_1.ReferenceArea);
