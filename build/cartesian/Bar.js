...
var Bar = (function (_super) {
    ...
    Bar.prototype.renderRectanglesStatically = function (data) {
        ...
        var baseProps = ReactUtils_1.filterProps(this.props);
        return (data &&
    ...
    Bar.prototype.renderBackground = function () {
        ...
        var backgroundProps = ReactUtils_1.filterProps(this.props.background);
    ...
    Bar.prototype.renderErrorBar = function (needClip, clipPathId) {
    ...
    Bar.getComposedData = function (_a) {
        ...
        var cells = ReactUtils_1.findAllByType(children, Cell_1.Cell);
        var rects = displayedData.map(function (entry, index) {
            ...
            if (layout === 'horizontal') {
                var _b = [yAxis.scale(value[0]), yAxis.scale(value[1])], baseValueScale = _b[0], currentValueScale = _b[1];
                ...
                y = (_a = currentValueScale !== null && currentValueScale !== void 0 ? currentValueScale : baseValueScale) !== null && _a !== void 0 ? _a : undefined;
                width = pos.size;
                ...
                var _c = [xAxis.scale(value[0]), xAxis.scale(value[1])], baseValueScale = _c[0], currentValueScale = _c[1];
                x = baseValueScale;
