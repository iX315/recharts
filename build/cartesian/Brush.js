...
var d3_scale_1 = require("victory-vendor/d3-scale");
...
var Brush = (function (_super) {
    ...
    Brush.prototype.handleTravellerMoveKeyboard = function (direction, id) {
        var _a;
        var _this = this;
        var _b = this.state, scaleValues = _b.scaleValues, startX = _b.startX, endX = _b.endX;
        ...
        this.setState((_a = {},
            _a[id] = newScaleValue,
            _a), function () {
            _this.props.onChange(_this.getIndex({
    ...
    Brush.prototype.renderTravellerLayer = function (travellerX, id) {
        ...
        var travellerProps = __assign(__assign({}, ReactUtils_1.filterProps(this.props)), { x: x,
            y: y, width: travellerWidth, height: height });
        return (react_1.default.createElement(Layer_1.Layer, { tabIndex: 0, role: "slider", className: "recharts-brush-traveller", onMouseEnter: this.handleEnterSlideOrTraveller, onMouseLeave: this.handleLeaveSlideOrTraveller, onMouseDown: this.travellerDragStartHandlers[id], onTouchStart: this.travellerDragStartHandlers[id], onKeyDown: function (e) {
                if (!['ArrowLeft', 'ArrowRight'].includes(e.key)) {
                    return;
                }
                e.preventDefault();
                e.stopPropagation();
                _this.handleTravellerMoveKeyboard(e.key === 'ArrowRight' ? 1 : -1, id);
            }, onFocus: function () {
                _this.setState({ isTravellerFocused: true });
            }, onBlur: function () {
                _this.setState({ isTravellerFocused: false });
            }, style: { cursor: 'col-resize' } }, Brush.renderTraveller(traveller, travellerProps)));
    };
    ...
    Brush.prototype.render = function () {
        ...
        var _b = this.state, startX = _b.startX, endX = _b.endX, isTextActive = _b.isTextActive, isSlideMoving = _b.isSlideMoving, isTravellerMoving = _b.isTravellerMoving, isTravellerFocused = _b.isTravellerFocused;
        if (!data ||
            !data.length ||
