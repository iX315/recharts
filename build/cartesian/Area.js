...
var Area = (function (_super) {
    ...
    Area.prototype.renderDots = function (needClip, clipDot, clipPathId) {
        ...
        var areaProps = ReactUtils_1.filterProps(this.props);
    ...
    Area.prototype.renderAreaStatically = function (points, baseLine, needClip, clipPathId) {
        ...
        return (react_1.default.createElement(Layer_1.Layer, { clipPath: needClip ? "url(#clipPath-" + clipPathId + ")" : null },
            react_1.default.createElement(Curve_1.Curve, __assign({}, ReactUtils_1.filterProps(others, true), { points: points, connectNulls: connectNulls, type: type, baseLine: baseLine, layout: layout, stroke: "none", className: "recharts-area-area" })),
            stroke !== 'none' && (react_1.default.createElement(Curve_1.Curve, __assign({}, ReactUtils_1.filterProps(this.props), { className: "recharts-area-curve", layout: layout, type: type, connectNulls: connectNulls, fill: "none", points: points }))),
            stroke !== 'none' && isRange && (react_1.default.createElement(Curve_1.Curve, __assign({}, ReactUtils_1.filterProps(this.props), { className: "recharts-area-curve", layout: layout, type: type, connectNulls: connectNulls, fill: "none", points: baseLine })))));
    };
    ...
    Area.prototype.render = function () {
        var _a;
        var _b = this.props, hide = _b.hide, dot = _b.dot, points = _b.points, className = _b.className, top = _b.top, left = _b.left, xAxis = _b.xAxis, yAxis = _b.yAxis, width = _b.width, height = _b.height, isAnimationActive = _b.isAnimationActive, id = _b.id;
