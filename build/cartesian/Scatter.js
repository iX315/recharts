...
var Scatter = (function (_super) {
    ...
    Scatter.prototype.renderSymbolsStatically = function (points) {
        ...
        return points.map(function (entry, i) {
            ...
            return (react_1.default.createElement(Layer_1.Layer, __assign({ className: "recharts-scatter-symbol" }, types_1.adaptEventsOfChild(_this.props, entry, i), { key: "symbol-" + i, role: "img" }), Scatter.renderSymbolItem(activeIndex === i ? activeShape : shape, props)));
        });
    };
    ...
    Scatter.prototype.renderErrorBar = function () {
        ...
        return errorBarItems.map(function (item, i) {
            ...
            return react_1.default.cloneElement(item, {
                ...
                dataPointFormatter: function (dataPoint, dataKey) {
                    return {
                        x: dataPoint.cx,
                        y: dataPoint.cy,
    ...
    Scatter.prototype.renderLine = function () {
        ...
        var scatterProps = ReactUtils_1.filterProps(this.props);
        var customLineProps = ReactUtils_1.filterProps(line);
    ...
    Scatter.getComposedData = function (_a) {
        ...
        var cells = ReactUtils_1.findAllByType(item.props.children, Cell_1.Cell);
