...
var resolveCollisions = function (depthTree, height, nodePadding, sort) {
...
var computeData = function (_a) {
    var data = _a.data, width = _a.width, height = _a.height, iterations = _a.iterations, nodeWidth = _a.nodeWidth, nodePadding = _a.nodePadding, sort = _a.sort;
...
var Sankey = (function (_super) {
    ...
    Sankey.getDerivedStateFromProps = function (nextProps, prevState) {
        ...
        if (data !== prevState.prevData ||
            ...
            return __assign(__assign({}, prevState), { nodes: nodes,
                links: links, prevData: data, prevWidth: iterations, prevHeight: height, prevMargin: margin, prevNodePadding: nodePadding, prevNodeWidth: nodeWidth, prevIterations: iterations, prevSort: sort });
        }
        return null;
    };
    ...
    Sankey.prototype.renderLinks = function (links, nodes) {
        ...
        return (react_1.default.createElement(Layer_1.Layer, { className: "recharts-sankey-links", key: "recharts-sankey-links" }, links.map(function (link, i) {
            ...
            var linkProps = __assign({ sourceX: sourceX,
                ...
                linkWidth: linkWidth, index: i, payload: __assign(__assign({}, link), { source: source, target: target }) }, ReactUtils_1.filterProps(linkContent));
            var events = {
    ...
    Sankey.renderNodeItem = function (option, props) {
        ...
        return (react_1.default.createElement(Rectangle_1.Rectangle, __assign({ className: "recharts-sankey-node", fill: "#0088fe", fillOpacity: "0.8" }, ReactUtils_1.filterProps(props), { role: "img" })));
    };
    Sankey.prototype.renderNodes = function (nodes) {
        ...
        return (react_1.default.createElement(Layer_1.Layer, { className: "recharts-sankey-nodes", key: "recharts-sankey-nodes" }, nodes.map(function (node, i) {
            ...
            var nodeProps = __assign(__assign({}, ReactUtils_1.filterProps(nodeContent)), { x: x + left, y: y + top, width: dx, height: dy, index: i, payload: node });
            var events = {
    ...
    Sankey.prototype.render = function () {
        ...
        return (react_1.default.createElement("div", { className: classnames_1.default('recharts-wrapper', className), style: __assign(__assign({}, style), { position: 'relative', cursor: 'default', width: width, height: height }), role: "region" },
