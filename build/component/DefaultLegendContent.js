...
var DefaultLegendContent = (function (_super) {
    ...
    DefaultLegendContent.prototype.renderItems = function () {
        ...
        return payload.map(function (entry, i) {
            ...
            var entryValue = !lodash_1.default.isFunction(entry.value) ? entry.value : null;
            LogUtils_1.warn(!lodash_1.default.isFunction(entry.value), "The name property is also required when using a function for the dataKey of a chart's cartesian components. Ex: <Bar name=\"Name of my Data\"/>");
            ...
            return (react_1.default.createElement("li", __assign({ className: className, style: itemStyle, key: "legend-item-" + i }, types_1.adaptEventsOfChild(_this.props, entry, i)),
                ...
                react_1.default.createElement("span", { className: "recharts-legend-item-text", style: { color: color } }, finalFormatter ? finalFormatter(entryValue, entry, i) : entryValue)));
        });
    };
