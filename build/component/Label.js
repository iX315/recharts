...
var isPolar = function (viewBox) {
    return 'cx' in viewBox && DataUtils_1.isNumber(viewBox.cx);
};
function Label(_a) {
    var _b = _a.offset, offset = _b === void 0 ? 5 : _b, restProps = __rest(_a, ["offset"]);
    var props = __assign({ offset: offset }, restProps);
    var viewBox = props.viewBox, position = props.position, value = props.value, children = props.children, content = props.content, _c = props.className, className = _c === void 0 ? '' : _c, textBreakAll = props.textBreakAll;
    ...
    var attrs = ReactUtils_1.filterProps(props, true);
...
var renderCallByParent = function (parentProps, viewBox, checkPropsLabel) {
    ...
    var explicitChildren = ReactUtils_1.findAllByType(children, Label).map(function (child, index) {
    ...
    return __spreadArrays([implicitLabel], explicitChildren);
};
