...
function Surface(props) {
    ...
    return (react_1.default.createElement("svg", __assign({}, ReactUtils_1.filterProps(others, true, 'svg'), { className: layerClass, width: width, height: height, style: style, viewBox: svgView.x + " " + svgView.y + " " + svgView.width + " " + svgView.height }),
