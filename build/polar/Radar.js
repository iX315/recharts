...
var Radar = (function (_super) {
    ...
    Radar.prototype.renderDots = function (points) {
        ...
        var customDotProps = ReactUtils_1.filterProps(dot);
    ...
    Radar.prototype.renderPolygonStatically = function (points) {
        ...
        if (react_1.default.isValidElement(shape)) {
            ...
            radar = (react_1.default.createElement(Polygon_1.Polygon, __assign({}, ReactUtils_1.filterProps(this.props, true), { onMouseEnter: this.handleMouseEnter, onMouseLeave: this.handleMouseLeave, points: points, baseLinePoints: isRange ? baseLinePoints : null, connectNulls: connectNulls })));
        }
