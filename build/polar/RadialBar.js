...
var RadialBar = (function (_super) {
    ...
    RadialBar.prototype.renderSectorsStatically = function (sectors) {
        ...
        var baseProps = ReactUtils_1.filterProps(others);
        return sectors.map(function (entry, i) {
            var props = __assign(__assign(__assign(__assign(__assign({}, baseProps), { cornerRadius: cornerRadius }), entry), types_1.adaptEventsOfChild(_this.props, entry, i)), { key: "sector-" + i, className: "recharts-radial-bar-sector " + entry.className, forceCornerRadius: others.forceCornerRadius, cornerIsExternal: others.cornerIsExternal });
    ...
    RadialBar.prototype.render = function () {
        ...
        return (react_1.default.createElement(Layer_1.Layer, { className: layerClass },
            ...
            (!isAnimationActive || isAnimationFinished) && LabelList_1.LabelList.renderCallByParent(__assign({}, this.props), data)));
    };
