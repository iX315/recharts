...
var PolarRadiusAxis = (function (_super) {
    ...
    PolarRadiusAxis.prototype.renderAxisLine = function () {
        ...
        var props = __assign(__assign(__assign(__assign({}, ReactUtils_1.filterProps(others)), { fill: 'none' }), ReactUtils_1.filterProps(axisLine)), { x1: point0.x, y1: point0.y, x2: point1.x, y2: point1.y });
    ...
    PolarRadiusAxis.prototype.renderTicks = function () {
        ...
        var axisProps = ReactUtils_1.filterProps(others);
