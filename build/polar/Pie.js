...
var Pie = (function (_super) {
    ...
    Pie.prototype.renderLabels = function (sectors) {
        ...
        var pieProps = ReactUtils_1.filterProps(this.props);
        var customLabelProps = ReactUtils_1.filterProps(label);
        var customLabelLineProps = ReactUtils_1.filterProps(labelLine);
    ...
    Pie.prototype.renderSectorsStatically = function (sectors) {
        ...
        return sectors.map(function (entry, i) {
            ...
            return (react_1.default.createElement(Layer_1.Layer, __assign({ ref: function (ref) {
                ...
                }, tabIndex: -1, className: "recharts-pie-sector" }, types_1.adaptEventsOfChild(_this.props, entry, i), { key: "sector-" + i }), Pie.renderSectorItem(sectorOptions, sectorProps)));
        });
    };
    ...
    Pie.prototype.render = function () {
        ...
        return (react_1.default.createElement(Layer_1.Layer, { tabIndex: this.props.rootTabIndex, className: layerClass, ref: function (ref) {
                _this.pieRef = ref;
            } },
            this.renderSectors(),
    ...
    Pie.getRealPieData = function (item) {
        ...
        var presentationProps = ReactUtils_1.filterProps(item.props);
